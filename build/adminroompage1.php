      ...
      <div id="overlay" class="fixed inset-0 bg-black opacity-70 z-50 hidden"></div>
        ...
        <main class="bg-cover bg-center relative">
            <section id="racecover"
                ...
                <h1 class="pt-[30px] pb-[10px] drop-shadow-md font-[Montserrat] text-red-950 text-[33px] text-center font-[750]">CSM BUILDING - 1st FLOOR</h1>
                ...
                <!--First Row Rooms-->
                <section>
                    <div class="wrapper mt-[-40px] ml-[-3px]">
