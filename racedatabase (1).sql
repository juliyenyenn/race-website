...
('jcbontilao', 'juliyenyenn', 'jcbon1234', 'Juliene Airen C. Bontilao', 'Front End Developer', 'jcbontilao@up.edu.ph@up.edu.ph', 2147483647, 'Admin'),
...
('AMAT 110', 'Mathematical Mo'),
('AMAT 131', 'Statistical Met'),
('AMAT 132', 'Introductory Fo'),
('AMAT 152', 'Computer Progra'),
('AMAT 160', 'Linear Programm'),
('AMAT 161', 'Nonlinear Progr'),
('AMAT 167', 'Mathematical Mo'),
('AMAT 168', 'Mathematical Mo'),
('AMAT 190A', 'Special Problem'),
('AMAT 190B', 'Special Problem'),
('AMAT 190C', 'Special Problem'),
('AMAT 193', 'Geospatial Tool'),
('AMAT 199', 'Undergraduate S'),
('AMAT 200A', 'Undergraduate T'),
('AMAT 200B', 'Undergraduate T'),
('AMAT 200C', 'Undergraduate T'),
('BIO 100', 'Introduction to'),
('BIO 102', 'Cytology'),
('BIO 103', 'Advance Cell Bi'),
('BIO 110', 'Principles of E'),
('BIO 115', 'Intro to Philip'),
('BIO 143', 'Animal Physiolo'),
('BIO 144', 'Animal Histolog'),
('BIO 145', 'Introduction to'),
('BIO 164', 'Morphology and '),
('BIO 170', 'Evolutionary Bi'),
('BIO 176', 'Environmental M'),
('BIO 199b', 'Undergraduate S'),
('BIO 200-III', 'TBA'),
('BIO 200a', 'Undergraduate T'),
('BIO 200b', 'Undergraduate T'),
('BIO 200c', 'Undergraduate T'),
('BIO 21', 'Principles of M'),
('BIO 40', 'Intermediate Zo'),
('BIO 60', 'Intermediate Bo'),
('CHEM 141', 'Food Analysis'),
('CHEM 141.1', 'Food Analysis L'),
('CHEM 160', 'Introductory Bi'),
('CHEM 160.1', 'Introductory Bi'),
('CHEM 22', 'General Chemist'),
('CHEM 22.1', 'General Chemist'),
('CMSC 124', 'Design and Impl'),
('CMSC 125', 'Operating Syste'),
('CMSC 126', 'Web-Based Syste'),
('CMSC 127', 'File Processing'),
('CMSC 130', 'Logic Design an'),
('CMSC 134', 'Information Sto'),
('CMSC 137', 'Data Communicat'),
('CMSC 141', 'Automata and La'),
('CMSC 142', 'Design and Anal'),
('CMSC 183', 'IT Project Mana'),
('CMSC 186', 'Web Services an'),
('CMSC 190a', 'Special Problem'),
('CMSC 190c', 'Special Problem'),
('CMSC 191', 'Special Topics'),
('CMSC 200a', 'Undergraduate T'),
('CMSC 200c', 'Undergraduate T'),
('CMSC 28', 'Computer Progra'),
('CMSC 57', 'Discrete Mathem'),
('CSMC 200b', 'Undergraduate T'),
('DS 122', 'TBA'),
('DS 29', 'Methods of Proo'),
('DS 45', 'Modeling and Si'),
('DS 57', 'Introduction to'),
('FST 131', 'Food Engineeing'),
('FST 140', 'Food Processing'),
('FST 141', 'TBA'),
('FST 145', 'Processing of F'),
('FST 150', 'Food Chemistry '),
('FST 163', 'Food Laws and R'),
('FST 164', 'Food Safety'),
('FST 165', 'Quality Assuran'),
('FST 199', 'Undergraduate S'),
('FST 200B', 'Undergraduate T'),
('FST 200C', 'Undergraduate T'),
('FST 202', 'TBA'),
('FST 221', 'TBA'),
('FST 299', 'TBA'),
('FST 300', 'TBA'),
('MATH 10', 'Mathematics, Cu'),
('MATH 101', 'Logic and Set T'),
('MATH 111', 'Abstract Algebr'),
('MATH 155', 'Advanced Calcul'),
('MATH 26', 'Analytic Geomet'),
('MATH 28', 'Analytic Geomet'),
('MATH 36', 'Mathematical An'),
('MATH 37', 'Mathematical An'),
('MATH 38', 'Mathematical An'),
('PHYS 13', 'General Physics'),
('PHYS 3', 'Heat and Mechan'),
('PHYS 72', 'University Phys'),
('PHYS 72.1', 'University Phys'),
('SCIENCE 10', 'Probing the Phy'),
('SCIENCE 11', 'Living Systems:'),
('STAT 1', 'Elementary Stat'),
('STS 1', 'Science, Techno');
